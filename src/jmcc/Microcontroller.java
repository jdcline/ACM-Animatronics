...
public abstract class Microcontroller {
	 ...
	 * @param pin
	 * @param position
	 * @return a byte sequence for writing to serial port to move a servo to a target position
	 */
	...
	// there is a change in the command, only the base function needs to change.
}
